...
func (conn *simpleDeviceConnection) ReadUntilFunc(ctx context.Context, timeout time.Duration, f func([]byte) bool) {
	conn.Start(ctx)
...
func (conn *simpleDeviceConnection) ReadUntilMatch(ctx context.Context, regex *regexp.Regexp, timeout time.Duration) ([]byte, error) {
	conn.Start(ctx)
